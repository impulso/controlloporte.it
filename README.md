...
## Files Not Included In The Public Repository

The files `frontend/web/src/assets/llms.txt` and `frontend/web/src/assets/llms-full.txt` are not included in the public repository.

If needed in production, they should be handled as separate deployment assets.
